...
public class WithdrawContestCommand implements ICommand{
    ...
    public void execute(List<String> tokens) {
        ...
        //     System.out.println("RegisterContestDto [contestName " + userRegistrationDto.getContestName() + ", registrationStatus=" + userRegistrationDto.getRegisterationStatus() + ", userName=" + userRegistrationDto.getUserName() + "]");
        // } 
